...
8. Conjugate Priors for Exponential Family distributions
...
16. In Lab07, we barely brushed the surface of the bootstrap. Research and show some results about bootstrap estimators (e.g. consistency, bias, theoretical coverage of confidence intervals, etc.). You could also explore situations where the bootstrap fails. 
